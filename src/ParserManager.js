...
class ParserManager {
     ...
     * @returns {Array.<Class>} the array of parsers that handle
     ...
     * can find them.
     *
     * @param {Array.<Class>} parsers the list of parsers to add
     */
    add(parsers) {
     ...
     *
     * @returns {Object.<string, string>} the parser names and descriptions
     */
    getDescriptions() {
